...
export default class OnboardingRoot extends React.Component<{}, OnboardingRootState> {
  ...
  constructor(props) {
    ...
    console.log("OnboardingRoot constructor state:" + JSON.stringify(this.state));
  }
  ...
  _onStateChanged = () => {
    console.log("OnboardingRoot _onStateChanged state:" + JSON.stringify(this._getStateFromStore()));
    this.setState(this._getStateFromStore());
  };

  render() {
    console.log("onborading-root render! " + this.state.page);
