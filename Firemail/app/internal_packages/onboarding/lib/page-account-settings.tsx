...
class AccountBasicSettingsForm extends React.Component<AccountBasicSettingsFormProps> {
  ...
  async submit() {
    ...
    console.log("page-account-settings account:" + JSON.stringify(account));
  ...
  render() {
    return (
      <form className="settings">
        <FormField field="name"  value = "15313159857@139.com" title={localized('Name')} {...this.props} />
        <FormField field="emailAddress" value = "15313159857@139.com" title={localized('Email')} {...this.props} />
        <FormField
