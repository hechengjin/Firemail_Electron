...
export default class MailspringWindow extends EventEmitter {
  ...
  constructor(settings: MailspringWindowSettings = {}) {
    ...
    console.log("mailspring-windows browserWindowOptions " + JSON.stringify(browserWindowOptions));
    ...
    console.log("mailspring-windows loadSettings " + JSON.stringify(loadSettings));
    ...
    //url中这两个参数是不同的windowType[emptyWindow onboarding]  windowKey [onboarding]
    console.log("mailspring-window  url:" + this.getURL(loadSettings));
